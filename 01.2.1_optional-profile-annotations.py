...
fgwas_dir = "path_to_fgwas_dir"
fgwas_input_dir = fgwas_dir + "fgwas_input/"
bed_dir = fgwas_input_dir + "bed_files/"
if os.path.isdir(bed_dir)==False:
    os.makedirs(bed_dir)
annot_bed = fgwas_input_dir + "anno_input.bed" # bed file with all annotations used in fgwas file
gwas_bed = "path_to_gwas_bed_file"
fgwas_file = fgwas_input_dir  + "input_file.fgwas.gz"
start_index=9
...
def three_intersect(gwas_bed,a1,a2):
