...
serv.dir <- "path_to_directory_on_server" # Used when working from Rstudio locally but mounted to a server file system (e.g. MacOX-Fuse) 
fgwas.dir <- serv.dir %&% "path_to_fgwas_direcotry"
fgwas.out.dir <- fgwas.dir %&% "fgwas_output/"
best.joint.model.file.prefix <- fgwas.out.dir %&% "best-joint-model"

my.title <- "My Title"
output.prefix <- "my-analysis"

annotation.keyfile <- NULL # fgwas.dir %&% "plot-key.csv"# Optional: Specifiy if you have a comma-delimited csv file with annotation names (as they appear in the fgwas input file) on the left column and plotting names on the right column, column names should be Name and PlotName, otherwise set to NULL
